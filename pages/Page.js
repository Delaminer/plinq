import { Routes, Route, BrowserRouter, NavLink, Redirect } from 'react-router-dom';
...
export default function Page() {
    ...
    return (
        <main>
            <BrowserRouter>
                <nav>
                    <NavLink activeClassName='active' to='/reminders'>Reminders</NavLink>
                    <NavLink activeClassName='active' to='/networks'>Networks</NavLink>
                    <NavLink activeClassName='active' to='/templates'>Templates</NavLink>
                </nav>
