        ...
        {contacts.sort(sort).map((contact) => (
          ...
          >
            <div className="float-right">
              <BsFillCircleFill className={"fill-"+colorTime(new Date(contact.nextContact))}/>
            </div>
            <div className="flex flex-row">
              ...
              <div className="flex flex-col mr-2">
                ...
                {(contact.job && contact.company) && <p key="job" className="text-gray-4">
            ...
            <div className="flex flex-row justify-center gap-10">
              <div className="flex flex-col">
                ...
                <p className="text-sm text-center">{nameText(new Date(contact.lastContact))}</p>
              </div>
              <div className="flex flex-col">
                <p className="text-sm text-gray-3 text-center">Next Contact</p>
                <p className="text-sm font-bold text-center">{nameText(new Date(contact.nextContact))}</p>
              </div>
            </div>
